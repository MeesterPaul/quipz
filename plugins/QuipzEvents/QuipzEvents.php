 ...
 * original location:
 *
 * <https://github.com/picocms/Pico/blob/master/plugins/QuipzEvents.php>
 *
 ...
 * @version 2.1
 */
class QuipzEvents extends AbstractPicoPlugin
{
    /**
     ...
     * {@see QuipzEvents::$dependsOn}), Pico enables the plugin by default.
...
//    protected $dependsOn = array();
     ...
     *
     * @see QuipzEvents::onThemeLoading()
     * @see Pico::getTheme()
     ...
     * @see QuipzEvents::onContentLoaded()
     */
     ...
     * @see QuipzEvents::on404ContentLoaded()
     */
     ...
     *
     * @see QuipzEvents::on404ContentLoading()
     ...
     * case when necessary.
     *
     * @see QuipzEvents::onContentLoading()
     * @see Pico::getRawContent()
     * @see Pico::is404Content()
     *
     * @param string &$rawContent raw file contents
     ...
     * @see QuipzEvents::onContentPrepared()
     * @see QuipzEvents::onContentParsed()
     */
     ...
     *
     * @see QuipzEvents::onContentParsing()
     ...
     *
     * @see QuipzEvents::onPagesDiscovered()
     * @see QuipzEvents::onPagesLoaded()
     */
     ...
     *
     * @see QuipzEvents::onSinglePageContent()
     * @see QuipzEvents::onSinglePageLoaded()
     *
     ...
     *
     * @see QuipzEvents::onSinglePageLoading()
     * @see QuipzEvents::onSinglePageLoaded()
     *
     * @param string $id          relative path to the content file
     * @param string &$rawContent raw file contents
     ...
     * page's data.
     *
     * @see QuipzEvents::onPagesLoading()
     * @see QuipzEvents::onPagesLoaded()
     *
     ...
     *
     * @see QuipzEvents::onPageRendered()
     *
     ...
     *
     * @see QuipzEvents::onPageRendering()
     *
    ...
    public function onTwigRegistered(Twig_Environment &$twig)
    {
        ...
        $twig->addFunction(new Twig_SimpleFunction('quipzevents', function () {
            return file_get_contents("https://".$_SERVER['SERVER_NAME']."/ics/");
        }));
